...
Dato che la produzione di un brano implica l'impiego di attrezzature per l'acquisizione dei suoni, altre per il loro trattamento, la loro sintesi, l'arrangiamento e il mixaggio, in aggiunta al costo e all'ingombro di tale attrezzatura, gli studi di registrazione sono delle strutture estremamente specializzate con un alto costo di gestione e manutenzione ciò limitava la produzione musicale alle sole major.
