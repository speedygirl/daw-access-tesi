...
A completamento del lavoro ho stabilito un contatto con alcune delle software house e curato brevi interviste con sviluppatori e responsabili di prodotto, nella speranza non solo di raccogliere ulteriori informazioni di rilievo, ma anche di offrire alle case stesse feedback potenzialmente utili per gli sviluppi futuri dei propri software in relazione all'accessibilità. <!-- in generale cerca di essere chiara e molto neutra/diplomatica quando parli di altri, parlare di aziende che seguono solo interessi economici o di frustrazioni/mancanza di supporto ecc non porta nulla di utile alla tesi e ti mette in una posizione difficile (se si formulano accuse bisogna anche essere in grado di sostenerle con documenti alla mano, non basta gettare il sasso e poi ritirare la mano..)-->
...
Se è impossibile riprodurre eventi sonori identici all'originale, è però difficile anche ottenere risultati che gli si avvicinino, per una serie di problemi.
Il primo è l'acustica degli ambienti in cui il suono viene prodotto, dato che ogni tipo di musica necessiterebbe di uno specifico ambiente mentre spesso questi, non essendo stati progettati allo scopo, sono privi degli indispensabili requisiti <!-- in che senso? È una citazione? Che l'ambiente condizioni l'ascolto è vero, ma che servano ambienti specifici in base al tipo di musica mi sembra molto discutibile. Personalmente toglierei completamente la questione dell'ambiente acustico di riproduzione. -->.
Una registrazione curata in tutti i suoi aspetti, posizione e cura della presa di suono, giusta dose di riverbero, componenti di elevata qualità, ambienti adatti, può consentire una riproduzione eccellente in qualsiasi contesto, senza far rimpiangere la musica dal vivo. Naturalmente condizione imprescindibile è che non solo gli strumenti degli studi di registrazione e produzione siano di elevata qualità, ma che lo siano anche quelli utilizzati dall'utente per la riproduzione. Le aziende americane cominciarono allora a dedicarsi all'amplificazione del suono e alla sua diffusione con amplificatori e casse sempre più potenti, in grado di restituire negli ambienti domestici dei suoni "puliti". Negli anni '60 cominciò a diffondersi l'impianto modulare, i cui componenti, giradischi,amplificatore, casse acustiche, venivano prodotti da aziende indipendenti specializzate. Negli anni '70 si raggiunsero dei risultati notevolissimi.
...
L'amplificatore incrementa il livello del segnale senza produrre alterazioni <!-- discutibile la questione delle alterazioni, toglierei -->. I primi e più famosi amplificatori furono: McIntosh uscito nel 1948 e Marantz nel 1950 <!-- queste sono marche, si riesce a recuperare i modelli precisi? -->. All'inizio erano a valvole, poi si diffusero gli amplificatori a transistor.
