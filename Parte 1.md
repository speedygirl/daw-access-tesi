...
La produzione audio è è l’insieme delle attività che portano alla creazione di materiali sonori accessibili in formato digitale o su supporti analogici.
Essa comprende più fasi: registrazione, rielaborazione editing, produzione mastering, postproduzione.
La fase di registrazione può avvenire in presa diretta, osssia dal vivo in svariati contesti, oppure in studio dove si può scegliere se registrare in presa diretta o le singole tracce in successione. La seconda opzione permette una maggior qualità e più ampie possibilità di ritocchi sul materiale audio.
La fase di editing durante la quale si modificano porzioni delle tracce. 
Il mixaggio durante il quale si bilanciano le tracce e la successiva fase di mastering durante la quale si rielavorano ulteriormente le tracce mixate.
Il mastering non va confuso con il mastering relativo agli interi album che comprende anche operazioni come il bilanciamento generale tenendo conto delle relazioni tra le varie tracce, le pause che devono intercorrere tra la fine dell'una e l'inizio dell'altra.
...
Infine la post produzione è tutto quello che intercorre tra le registrazioni e il prodotto finito (comprende editing, sound design, mix, mastering…)
...
<!-- Fedeltà audio, qualità del mix, successo commerciale, sperimentazione.. Sono tutte cose diverse, qui si mettono assieme senza chiarirne i rapporti. -->
...
fatto <!-- qualitativamente rispetto a quali parametri? -->

In ogni caso l'ingegnere del suono "sound engenering" non ha soltanto una funzione tecnica ma anche artistica, infatti le procedure utilizzate per il trattamento delle tracce hanno un’influenza molto rilevante sugli effetti drammatici e emotivi del prodotto finale  per l’ascoltatore.
...
Nelle esecuzioni dal vivo invece, non è possibile un rimaneggiamento del materiale a causa delle condizioni ambientali che impongono l’uso di attrezzature più economiche, indi meno fedeli, che causano una bassa definizione in frequenza del suono. 
