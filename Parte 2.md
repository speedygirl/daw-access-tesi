...
La diffusione e lo sviluppo della rete Internet e del Web hanno portato particolare attenzione al tema in oggetto ed hanno determinato un'evidente accelerazione nell'imporsi del digitale come componente di estrema rilevanza nella vita delle persone. 
...
Questo processo ha visto anche la diffusione a livello di massa di strumenti tecnologici che prima erano riservati ad ambienti tecnici o lavorativi spesso elitari. La ricerca tecnologica unita all'ampliarsi esponenziale del pubblico di riferimento ha permesso infatti in tempi recenti una drastica riduzione dei costi degli strumenti tecnologici a fronte del loro continuo aumento prestazionale. In campo audio la diffusione di strumentazione e software dal prezzo accessibile ha democratizzato l'accesso agli strumenti di produzione musicale, fino all'ultimo decennio del secolo scorso sostanzialmente vincolati a budget e strutture di proporzioni significative. Le DAW, cui si rivolge questa tesi, possono essere considerate un'evoluzione digitale a basso costo (se paragonato con gli strumenti analogici corrispondenti) degli strumenti tecnici su cui si è storicamente basata la produzione musicale. 

In sintesi, che ci si riferisca al campo audio o fondamentalmente a qualsiasi altro ambito, si può constatare come nell’arco di pochi decenni gli strumenti hardware e software siano diventati un aspetto imprescindibile della vita sociale, artistica ed economica di ciascun individuo e della sua realizzazione personale, quantomeno nei paesi sviluppati.

Per molte tipologie di disabilità il diffondersi e l'affermarsi delle tecnologie digitali ha posto da sempre problemi legati alla difficoltà o impossibilità di accedere autonomamente alle risorse da esse offerte. È in questo contesto che si sono sviluppate le prime iniziative legislative da parte dei Governi, mirate a perseguire la parità di accesso alle tecnologie, con l’obbiettivo di colmare il divario presente tra disabili e persone non affette da disabilità e sviluppare un sistema sociale più equilibrato.  

## 2.2 Evoluzione normativa
Riporto di seguito un'esposizione delle normative che trattano l'accessibilità in ambito informatico secondo un criterio cronologico e "geografico", partendo dalle leggi sovranazionali fino a concentrarmi su quella Italiana, senza tralasciare i più recenti aggiornamenti.

Da quanto scritto sopra si può facilmente comprendere perchè l'interesse dei governi sia cominciato pensando all'acessibilità del Web più che dei software di produttività. Va inoltre tenuto conto del fatto che generalmente il settore pubblico non offre agli utenti dei software, quanto piuttosto servizi di vario genere, servizi che negli ultimi anni hanno seguito un percorso di costante aumento della componente digitale. Ritengo quindi opportuno affrontare il tema delle normative sull'accessibilità includendo anche i provvedimenti relativi non ad applicativi desktop (come le DAW di cui mi occupo in questa tesi) ma ad ambiti più o meno vicini, se non altro perché in futuro la legislazione relativa a Web e applicazioni mobile per l'erogazione di servizi potrebbe essere "trasferita" all'ambito delle applicazioni desktop, o quanto meno essere presa ad esempio o usata come riferimento nella stesura di nuove norme. Ritengo inoltre che molti degli aspetti affrontati nelle normative che andrò a presentare possano essere facilmente trasferiti a fini di analisi e ricerca nell'ambito degli applicativi desktop, nonostante questi ne siano esclusi da un punto di vista prettamente legale.
...
Risalgono all'anno successivo le linee guida per le metodologie per lo sviluppo e la verifica dell’accessibilità in applicazione della Legge, che consistono in 22 requisiti tecnici e, con esse, i criteri contenuti nelle WCAG 1.0.
...
Il sistema di screen reader con sintesi vocale è composto da due parti: una detta front-end e una back-end. Le due funzioni del front-end sono: la normalizzazione, ovvero un'analisi del testo che converta sigle, abbreviazioni, numeri in parole, e l'analisi linguistica, che traspone gli idiomi in fonemi facendone un'analisi linguistica in grado di creare intonazione, pause, respiri, periodi. 
La funzionalità che si occupa di riprodurre in suoni il contenuto testuale, analizzato e opportunamente filtrato dallo screen reader, è il baack-end ed è chiamata sintesi vocale, in quanto in grado di articolare suoni sintetizzati, quindi artificiali, in fonemi [^fonemi] Il sintetizzatore per funzionare sfrutta la scheda audio del computer e questo, come verrà esposto in seguito, comporta dei problemi di compatibilità con i software di produzione musicale.
...
I primi sintetizzatori ricreavano voci dal suono metallico e spesso la lettura risultava difficoltosa o addirittura incomprensibile, con evidenti riflessi negativi sulla comprensibilità del messaggio da parte dell’utilizzatore. Questa tecnologia, che ha avuto un ampio sviluppo avendo trovato riscontro in applicazioni commerciali, è stata continuamente migliorata negli anni, soprattutto dal punto di vista della naturalezza della lettura e dell’intelligibilità. Ora le voci sono molto simili a quelle umane, in grado di riprodurre suoni non solo comprensibili, ma che riflettono anche le intonazioni del parlato, come nel fondamentale caso delle frasi esclamative o interrogative. Notevoli progressi si riscontrano anche relativamente alla normalizzazione del testo.
Per contro sintesi molto elaborate e con voci simili alla dizione umana richiedono un utilizzo di risorse del computer molto ingenti, tali da rallentare l'esecuzione di operazioni anche elementari; questo è il motivo per cui si trovano in commercio sintesi con voci meno gradevoli che però riducono il carico della CPU, non intralciando lo svolgimento delle altre operazioni. Di conseguenza le voci molto elaborate vengono utilizzate di preferenza da enti e società che dispongono di grandi elaboratori, piuttosto che dal singolo utente.

Esistono varie modalità d’uso di una sintesi vocale, delle modalità di navigazione degli elementi e dei comandi per la lettura di un testo, che può essere navigato per caratteri, parole, righe.
[^mallard-youtube].
...
Molti sistemi operativi integrano screen reader dedicati: Linux utilizza Orca; Windows Vista, Windows 8 e 10, Windows XP, Windows 98, Windows ME e Windows NT supportano Narrator; Apple Mac OS X lo screen reader VoiceOver.[^funzionamento-screenreader-american-foundation] 
...
- color invertion, inversione cromatica dei colori: spesso i disabili visivi preferiscono leggere invertendo i colori, tipicamente portando il testo da nero su bianco a bianco/giallo su fondo blu/nero, al fine di ridurre la luminosità. Tale pratica risulta essere particolarmente utile nei casi di patologie di degenerazione della macula in età avanzata,
- smoothing: facendo un'interpolazione di pixel il software compensa la sgranatura dell'immagine dovuta all'ingrandimento eccessivo,
- cursor costumization, personalizzazione dei cursori: il software ne modifica alcuni parametri in modo da facilitarne l'identificazione a schermo ingrandendoli, scurendoli e modificandoli con varie gradazioni di colori che diano contrasto elevato rispetto allo sfondo,
- differenti modalità di ingrandimento:  il software fornisce modalità di ingrandimento personalizzabili, ad esempio impostando una zona di ingrandimento fissa, offrendo una lente da spostare all'interno dello schermo oppure l'intero schermo ingrandito.
Alcuni magnifier hanno integrati degli screen reader basilari per leggere la porzione di schermo ingrandita, che hanno il vantaggio di essere leggeri a livello di risorse di sistema richieste e di occupare poca memoria.

Di seguito sono riportati alcuni esempi di magnifier con relative procedure di attivazione, per permettere al lettore di provarli, dal momento che sono tutt'ora presenti di default nei più diffusi sistemi operativi.
...
L'ingranditore, nei sistemi sviluppati da Apple, è presente sin dalle prime versioni e poi implementato in tutte le tipologie di OS (iOS, MacOs, WatchOS, tvOS, iPadOS). In questo lavoro ci si concentrerà su quelli relativi alla piattaforma desktop, shortcut, mouse pad, scrool. [^mac-magnifier-attivazione] 
...
IBM è stata la prima ditta ad interessarsi di accessiblità sviluppando un suo screenreader per i dipendenti interni non vedenti denominato Home Page Reader, solo per poche applicazioni come WordPad, Windows Desktop, Notepad.
Narrator, per Windows 8 e successivi, è considerato leggermente migliore rispetto ai software simili in quanto meno complesso; tuttavia presentava difficoltà al primo utilizzo, in quanto non era presente un manuale utente di spiegazione dei comandi. Inoltre, come nel caso di JAWS, le shortcut prevedevano l'impiego del tasto Home, ergonomicamente scomodo.

Ritengo infine opportuno citare VoiceOver [^voiceover-apple-ufficiale] utilizzabile esclusivamente e con tutti i sistemi operativi sviluppati da Apple: risulta essere meglio strutturato dei precedenti elencati e, all'avvio del sistema operativo, l'utente non vedente può facilmente accedere al tutorial per imparare a usarlo. Presenta un numero minore di comandi rapidi rispetto a JAWS, comandi che prevedono i tasti chiave Cmd+Option (sovente abbreviati tasti modificatori di VoiceOver:VO), oppure Capslock o Insert, tasti che l'utente può decidere a sua discrezione se impostare come sostituti dei modificatori VO.
