...
## Il formato MP3
È un algoritmo di tipo lossy,in grado di comprimere e decomprimere, tramite encoder e decoder,  un file audio riducendolo anche di 12 volte la sua dimensione, mantenendone, secondo Giorgio Presti, una qualità e fedeltà quasi perfetta.
Prosegue Presti: i principali sistemi di compressione che riescano a mantenere il più fedelmente possibile la qualità del suono, sono il **lossless* e il **lossy** . 
I principali sistemi di compressione che riescano a mantenere il più fedelmente possibile la qualità del suono, sono il **lossless* (senza perdita di informazioni) e il **lossy** (perdita di informazioni) 
